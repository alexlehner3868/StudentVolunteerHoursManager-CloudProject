...
| **Student Dashboard**       | Frontend: Page for a student to view their hours progress and all of their submissions <br> Backend: API to query database and retrieve student's total hours and submission list | Alex |
